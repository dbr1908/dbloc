...
def banner():
	...
	r'''
                        __
  DBLOC ###the tools run to locate exact location    ''' + W)
	print('\n' + G + '[>]' + C + ' Created By: ' + W + 'Dbareh')
	print(G + '[>]' + C + ' Lada phi pyrshang wad ia nga te husiar phi dei ban tip shwa ia lade haei phi don.   : ' + W + version + '\n')
